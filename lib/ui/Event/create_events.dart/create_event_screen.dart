                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: _pickedImageFile != null || _webImage != null
                              ? (kIsWeb
                                  ? Image.memory(
                                    _webImage!,
                                    fit: BoxFit.cover,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return CustomButton(
                            ...
                            onTap: () async {
                              ...
                              model.pickedImageFile = _pickedImageFile;
                              model.webImage = _webImage;
                              model.eventModel.category = model.selectedCategory!;
                              model.eventModel.date = _dateController.text;
                              model.eventModel.hostUserId = currentUser?.uid;

                              final error = await model.addEventToDB(
                                model.eventModel,
                                '$firstName $surName',
                              );
