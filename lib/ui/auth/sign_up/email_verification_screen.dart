...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  Future<void> checkVerification() async {
    ...
    try {
      ...
      if (mounted) {
        AppMessenger.show(context, 'Something went wrong: $e', isError: true);
      }
    } finally {
      setState(() {
        isLoading = false;
  ...
  Future<void> resendVerificationEmail() async {
    try {
      ...
      if (mounted) {
        AppMessenger.show(context, 'Please check your inbox again.');
      }
    } catch (e) {
      if (mounted) {
        AppMessenger.show(context, 'Failed to send email: $e', isError: true);
      }
    }
  }
