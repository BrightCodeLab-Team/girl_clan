...
import 'package:girl_clan/core/services/account_deletion_service.dart';
...
class ProfileViewModel extends BaseViewModel {
  ...
  Future<String?> updateUserProfileInformation({
    File? image,
    Uint8List? webImage,
  }) async {
  ...
  /// Permanently deletes the signed-in account and associated user data.
  Future<String?> deleteAccount() async {
    ...
    setState(ViewState.busy);
    try {
      final error = await locator<AccountDeletionService>().deleteAccount(user);
      if (error == null) clearData();
      return error;
    } finally {
      setState(ViewState.idle);
    }
